...
local defaults = {
    ...
    MSG_NEW_VERSION = "A newer version is available: %s (you have %s). Please update GroupFound on CurseForge.",
...
overrides.deDE = {
    ...
    MSG_NEW_VERSION = "Es gibt eine neuere Version: %s (du hast %s). Bitte aktualisiere GroupFound auf CurseForge.",
